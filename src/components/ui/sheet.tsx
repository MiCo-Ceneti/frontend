...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card border-border p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
        ...
        right: "inset-y-0 right-0 h-full w-3/4 max-w-xs border-l data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:animate-in data-[state=open]:slide-in-from-right",
      },
    },
